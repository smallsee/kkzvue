...
<script>
  ...
  import {postUpdateArticleList,getTopicList} from 'api/article';
  ...
  export default {
    ...
    mounted () {
      ...
      this.formValidate.thumb = this.$route.params.formValidate.thumb;
      this.formValidate.content = this.$route.params.formValidate.content;
      this.formValidate.topic = this.$route.params.formValidate.topic;
