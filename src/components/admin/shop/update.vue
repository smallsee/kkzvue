...
<script>
  ...
  export default {
    ...
    mounted () {
      ...
      this.formValidate.thumbList = this.$route.params.formValidate.thumb;
      this.uploadList = this.$route.params.formValidate.thumb;
      this.formValidate.num = this.$route.params.formValidate.num;
      this.formValidate.price = this.$route.params.formValidate.price;
      this.formValidate.id = this.$route.params.formValidate.id;
      this.formValidate.parent_id = this.$route.params.formValidate.category_id;
      this.formValidate.is_sale = this.$route.params.formValidate.is_sale;
      this.formValidate.sale_price = this.$route.params.formValidate.sale_price;
